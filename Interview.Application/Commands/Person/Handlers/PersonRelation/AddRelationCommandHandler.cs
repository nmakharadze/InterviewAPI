...
namespace Interview.Application.Commands.Person.Handlers
{
    ...
    /// </summary>
    public class AddRelationCommandHandler : IRequestHandler<AddRelationCommand, int>
    {
        ...
        public async Task<int> Handle(AddRelationCommand request, CancellationToken cancellationToken)
        {
